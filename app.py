...
def extract_data(page_content):
    ...
    prompt += "- Daily Rate Per Foot (return only value in dollars, return N/A if not found)\n"
    prompt += "- Weekly Rate Per Foot (return only value in dollars, return N/A if not found)\n"
    prompt += "- Monthly Rate Per Foot (return only value in dollars, return N/A if not found)\n"
    prompt += "- Annual Rate (return only value in dollars, return N/A if not found)\n"
    prompt += "- Total Slips\n"
